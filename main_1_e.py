...
parser.add_argument('--dataPath', type=str, default='/app/datasets/NetvLad/view-tags/Pittsburgh_Viewtag_1_e/', help='Path for centroid data.')
parser.add_argument('--runsPath', type=str, default='/app/datasets/NetvLad/view-tags/pytorch-netvlad-run-1-e/', help='Path to save runs to.')
