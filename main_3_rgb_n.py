...
parser.add_argument('--dataPath', type=str, default='/app/datasets/NetvLad/view-tags/Pittsburgh_Viewtag_3_rgb_n/', help='Path for centroid data.')
parser.add_argument('--runsPath', type=str, default='/app/datasets/NetvLad/view-tags/pytorch-netvlad-run-3-rgb-n/', help='Path to save runs to.')
